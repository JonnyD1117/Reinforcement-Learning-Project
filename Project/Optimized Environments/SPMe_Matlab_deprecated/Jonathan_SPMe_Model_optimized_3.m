...
%     end 
%     
%     [xn_new, xp_new, xe_new, Sepsi_p_new, Sepsi_n_new, dV_dEpsi_sp, soc_new, V_term, theta, docv_dCse, done_flag] = SPMe_step( xn, xp, xe, Sepsi_p, Sepsi_n, I_input, full_sim, init_flag, spme_params);
%         [xn_new, xp_new, xe_new, Sepsi_p_new, Sepsi_n_new, dV_dEpsi_sp, soc_new, V_term, theta, docv_dCse, done_flag] = SPMe_step( xn, xp, xe, Sepsi_p, Sepsi_n, I_input, full_sim, init_flag, spme_params);
% 
...
% load("C:\Users\Indy-Windows\Desktop\SPMe_opt3_const_vars.mat");
...
spme_params = load("C:\Users\Indy-Windows\Desktop\SPMe_opt3_const_vars.mat");
    ...
    [action_value, action_index, action_dict] = Discretization_Dict([min_action_val, max_action_val], num_q_actions);
...
%          I_input = action_value(action_index);
    ...
    [action_list, soc_val_list] = q_learning_policy(Q, num_q_states, num_q_actions, spme_params);
...
function action_ind =  epsilon_greedy_policy(state_ind, Q_table, Q_dims, epsilon)
    ...
    if rand() <= epsilon
        action_ind = randi([1 num_act],1,1);
...
% function [action_list, soc_list] = q_learning_policy(Q_table, num_states, num_actions, spme_params)
% 
% 
%     SOC_0 = .5;
%     I_input = 25.7;
...
%     [action_vals, action_index, action_dict] = Discretization_Dict([-I_input, I_input], num_actions);
% 
% 
%     
%     full_sim = 0;
...
%     end 
%                 
%         I_input = action_vals(action_index);
%         
