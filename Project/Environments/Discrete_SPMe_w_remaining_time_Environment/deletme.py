...
if __name__ == "__main__":
    ...
    theta_range = np.arange(stoi_p100, stoi_p0, .0001)

    for index, t in enumerate(theta_range):

        soc.append(compute_SOC(t, t)[1])

        result = OCP_Slope_Cathode(t)
        d_ocp.append(result)
    ...
    plt.figure()
    plt.plot(soc, d_ocp)
    plt.title("OCP Slope vs SOC")
    plt.xlabel("SOC")
    plt.ylabel("OCP Slope")
