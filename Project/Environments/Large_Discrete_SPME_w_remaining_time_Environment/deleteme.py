...
if __name__ == '__main__':
    ...
    model.load(path="C:/Users/Indy-Windows/Documents/Reinforcement-Learning-Project/Project/Environments/Large_Discrete_SPME_w_remaining_time_Environment/Large_D_SPMe_action_space_1_p1_n1/model/T_2_1_4.zip")
